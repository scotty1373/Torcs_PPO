...
class Actor_builder(nn.Module):
    def __init__(self):
        ...
        # torch.nn.init.uniform_(self.acc_meanDense2.weight, a=-3e-3, b=3e-3)
        self.acc_meanout = nn.Sigmoid()
        ...
        self.ori_meanDense2 = nn.Linear(256, 128)
        self.ori_meanDense2act = nn.ReLU()
        self.ori_meanDense3 = nn.Linear(128, 32)
        self.ori_meanDense3act = nn.ReLU()
        self.ori_meanDense4 = nn.Linear(32, 1)
        # torch.nn.init.uniform_(self.ori_meanDense4.weight, a=-1e-3, b=1e-3)
    ...
    def forward(self, common):
        ...
        ori_mean = self.ori_meanDense2act(ori_mean)
        ori_mean = self.ori_meanDense3(ori_mean)
        ori_mean = self.ori_meanDense3act(ori_mean)
        ori_mean = self.ori_meanDense4(ori_mean)
